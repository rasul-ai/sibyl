...
class Sibyl:
    def __init__(self):
        ...
        # Initialize the Llama model with cache
        # self.llm = ChatOllama(model=MODEL,  # specify the model (Llama 2, 7B in this case)
        #                       temperature=0,
        #                       base_url=OPENAI_API_BASE,  # local Ollama server URL
        #                       cache=cache)
        # self.llm_without_cache = ChatOllama(model=MODEL,  # specify the model (Llama 2, 7B in this case)
        #                                     temperature=0.1,
        #                                     base_url=OPENAI_API_BASE  # local Ollama server URL
        #                                    )
